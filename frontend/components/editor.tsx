...
import { fetchFiles, readFile, saveFile } from "@/lib/api";
...
export function CodeEditor({ category, onFileSelect }: CodeEditorProps) {
    ...
    const handleSave = async () => {
        ...
        setSaving(true);
        try {
            await saveFile(category, selectedFile, code);
    ...
    return (
        <div className="flex flex-col h-full border-r">
            <div className="p-4 border-b flex gap-2 items-center justify-between">
                ...
                <Button size="sm" onClick={handleSave} disabled={saving || !selectedFile}>
